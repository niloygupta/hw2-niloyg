...
public class PosTagNamedEntityRecognizer {
  ...
  private static PosTagNamedEntityRecognizer posTagNE;

  public static PosTagNamedEntityRecognizer getInstance()
  {
    if (posTagNE == null)
      posTagNE = new PosTagNamedEntityRecognizer();

    return posTagNE;
  }
  private PosTagNamedEntityRecognizer() {
